...
const AboutPage = () => {
  return (
    <>
      <div className='background2 flex flex-col items-start justify-center min-h-screen px-8 py-12'>
        <h1 className='text-4xl font-bold text-white mb-8 hover:text-gray-400 transition-colors duration-300 cursor-pointer '>
        ...
        <div className='flex flex-col '>
          <p className='text-lg text-gray-200 mb-6 max-w-xl'>
            ...
            your next favorite pair, we've got you covered.
          </p>
          <p className='text-lg text-gray-200 mb-6 max-w-xl'>
